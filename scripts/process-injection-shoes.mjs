...
const SRC = path.resolve("Assets/projects/footwear/Injetados");
const OUT = path.resolve("public/projects/footwear");
const CANVAS_W = 1600;
const CANVAS_H = 1200;
const MAP = [
  ["Bota.png", "injection-shoes-01.webp"],
  ["Casual.png", "injection-shoes-02.webp"],
  ["Chinelo.png", "injection-shoes-03.webp"],
  ["Sandalia baby.png", "injection-shoes-04.webp"],
  ["Sandalia.png", "injection-shoes-05.webp"],
  ["Sapatilha.png", "injection-shoes-06.webp"],
];
