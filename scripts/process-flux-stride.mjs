...
const SRC = path.resolve("Assets/projects/footwear/flux-stride");
const OUT = path.resolve("public/projects/footwear");
const CANVAS_W = 1600;
const CANVAS_H = 1200;

const MAP = [
  ["01.png", "flux-stride-01.webp"],
  ["02.png", "flux-stride-02.webp"],
  ["03.png", "flux-stride-03.webp"],
  ["04.png", "flux-stride-04.webp"],
];
