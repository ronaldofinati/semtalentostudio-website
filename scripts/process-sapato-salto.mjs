...
const SRC = path.resolve("Assets/projects/footwear/Sapato Salto");
const OUT = path.resolve("public/projects/footwear");
const CANVAS_W = 1600;
const CANVAS_H = 1200;
const MAP = [
  ["01.png", "sapato-salto-01.webp"],
  ["02.png", "sapato-salto-02.webp"],
  ["03.png", "sapato-salto-03.webp"],
  ["04.png", "sapato-salto-04.webp"],
  ["05.png", "sapato-salto-05.webp"],
];
