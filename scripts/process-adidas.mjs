...
const SRC = path.resolve("Assets/projects/footwear/adidas");
const OUT = path.resolve("public/projects/footwear");
const CANVAS_W = 1600;
const CANVAS_H = 1200;
const MAP = [
  ["01.png", "adidas-01.webp"],
  ["02.png", "adidas-02.webp"],
  ["03.png", "adidas-03.webp"],
  ["04.png", "adidas-04.webp"],
  ["05.png", "adidas-05.webp"],
];
