...
const SRC = path.resolve("Assets/projects/footwear/Sneaker Color Combo");
const OUT = path.resolve("public/projects/footwear");
const CANVAS_W = 1600;
const CANVAS_H = 1200;
const MAP = [
  ["Sneaker Cor 01.png", "sneaker-color-combo-01.webp"],
  ["Sneaker Cor 02.png", "sneaker-color-combo-02.webp"],
  ["Sneaker Cor 03.png", "sneaker-color-combo-03.webp"],
  ["Sneaker Cor 04.png", "sneaker-color-combo-04.webp"],
  ["Sneaker Monocromatic Black.png", "sneaker-color-combo-05.webp"],
  ["Sneaker Monocromatic White.png", "sneaker-color-combo-06.webp"],
];
